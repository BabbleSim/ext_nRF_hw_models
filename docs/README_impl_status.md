...
| **GPIO**        | General purpose input/output                               | &#x2714;     | &#x2610;    | &#x2714;     | See [NRF_GPIO.c](../src/HW_models/NRF_GPIO.c); for 53 only NET core GPIO present                              |
| **GPIOTE**      | GPIO tasks and events                                      | &#x2705;     | &#x2610;    | &#x2714;     | See [NRF_GPIOTE.c](../src/HW_models/NRF_GPIOTE.c); for 53 only NET core one  |
