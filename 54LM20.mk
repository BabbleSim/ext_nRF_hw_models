...
HW_SRCS_FILE=make_inc/54LM20_hw_files
HAL_FLPR_SRCS_FILE=make_inc/54LM20_flpr_hal_files
HAL_APP_SRCS_FILE=make_inc/54LM20_app_hal_files
...
ifneq (,$(findstring hal_flpr,$(MAKECMDGOALS)))
 ...
 HAL_VARIANT=-DNRF54LM20A_XXAA -DNRF54LM20A_ENGA_XXAA -DNRF_FLPR
else ifneq (,$(findstring hal_app,$(MAKECMDGOALS)))
 SRCS:=${SRCS_HAL_APP}
 LIB_VARIANT:=_hal_app
 HAL_VARIANT=-DNRF54LM20A_XXAA -DNRF54LM20A_ENGA_XXAA -DNRF_APPLICATION
else #hw
 SRCS:=${SRCS_HW}
 LIB_VARIANT:=
 HAL_VARIANT=-DNRF54LM20A_XXAA -DNRF54LM20A_ENGA_XXAA -DNRF_APPLICATION
endif
VARIANT=NRF54LM20${LIB_VARIANT}
...
A_LIBS32:=
SO_LIBS:=
CFLAGS=${COMMON_CC_FLAGS} ${INCLUDES} -DNRF54LM20 ${HAL_VARIANT}
